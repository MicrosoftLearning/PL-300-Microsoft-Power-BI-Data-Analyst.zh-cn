...
在本练习中，使用涉及筛选器上下文操作的 DAX 表达式来创建度量值。
...
1. 若要配置矩阵视觉对象字段，请将“Region \| Regions”层次结构从“字段”窗格中拖放到视觉对象中 。
...
1. 务必选中“字段”窗格中的“Sales All Region”度量值（选中后呈现深灰色背景），然后将公式栏中的度量值名称和公式替换为以下公式：
