...
1. 若要查找特定列，请在“开始”功能区选项卡上的“管理列”组中，选择“选择列”向下箭头，然后选择“转到列”****************。
    ...
    > _****“转到列”是具有许多列的有用功能。否则，可以水平滚动以查找列。_

    ![“管理列”>“选择列”>“转到列”](Linked_image_Files/02-transform-data-power-bi_image13.png)

1. 在“转到列”窗口中，若要按列名对列表进行排序，请选择“AZ”排序按钮，然后选择“名称”************。 
...
1. 若要删除列，请在“开始”功能区选项卡上的“管理列”组中，选择“选择列”图标************。
...
1. 右键单击任一所选列标题，然后在上下文菜单中选择“合并列”。
    ...
    > 可以通过以下方式应用许多常见的转换：右键单击列标头，然后从上下文菜单中进行选择。*请注意，功能区中还提供了更多转换。*
...
1. 将 EmailAddress 列重命名为 UPN。********

    > *UPN 是用户主体名称的缩写。*

在 Power Query 编辑器左下方的状态栏中，验证查询是否有 5 列、18 行。****
...
1. 在 BusinessType 列标头上，选择向下箭头，然后查看非重复列值，并注意 Warehouse 和 Ware House 这两个值************。

1. 右键单击 BusinessType 列标头，然后选择“替换值”********。
