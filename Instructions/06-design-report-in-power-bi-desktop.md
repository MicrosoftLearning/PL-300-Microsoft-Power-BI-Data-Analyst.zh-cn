...
1. 在“字段”窗格中，将“Date \| Year”字段（而不是层次结构的“Year”级别）拖到“可视化效果”窗格中的切片器“字段”中   。
...
1. 请注意，在视觉对象字段窗格（不是“字段”窗格 - 视觉对象字段窗格位于“可视化效果”窗格下方）中，这些字段已分配给“X 轴”和“Y 轴列”井/区域   。
...
1. 将“Sales \| Profit Margin”字段从“字段”窗格拖动到“Y 轴行”井中  。
...
1. 将“Product \| Category”字段从“字段”窗格拖动到“筛选此页”井/区域中  。
...
在本练习中，将报表发布到 Power BI 服务并浏览只读使用者报表。
...
1. 查看工作区内容。 请注意“全部”、“内容”和“数据集 + 数据流”的导航选项。
    1. 工作区中可以有四种类型的项，我们将讨论报表和数据集。 
    1. 如果数据集不可见，可能需要刷新 Microsoft Edge 浏览器。
    1. *当你发布了 Power BI Desktop 文件后，数据模型已发布为数据集。*
